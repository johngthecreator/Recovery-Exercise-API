...
export const addOneExercise = async (req: Request, res: Response) => {
    try {
        await client.connect();
        const myDB = client.db("recovery_exercises")
        const myColl = myDB.collection("exercises");
...
export const updateOneExercise = async (req: Request, res: Response) => {
    try {
        await client.connect();
        const myDB = client.db("recovery_exercises")
        const myColl = myDB.collection("exercises");
...
export const deleteOneExercise = async (req: Request, res: Response) => {
    try {
        await client.connect();
        const myDB = client.db("recovery_exercises")
        const myColl = myDB.collection("exercises");
